...
pub unsafe fn functional_child(frame: usize, index: i32) -> Option<usize> {
    ...
    if super::natives::frame_inherits_from_control(ft, false) {
...
pub unsafe fn set_width(frame: usize, value: f32) -> bool {
    ...
    let f: CLayoutFrameSetWidthFn =
        unsafe { core::mem::transmute(crate::addresses::get().c_layout_frame_set_width) };
...
pub unsafe fn set_height(frame: usize, value: f32) -> bool {
    ...
    let f: CLayoutFrameSetHeightFn =
        unsafe { core::mem::transmute(crate::addresses::get().c_layout_frame_set_height) };
    unsafe { f(layout, value) };
    true
}
...
pub unsafe fn set_level(frame: usize, level: i32) -> bool {
    ...
    if unsafe { frame_registry::is_simple(frame) } {
        let f: CSimpleFrameSetFrameLevelFn =
            unsafe { core::mem::transmute(crate::addresses::get().c_simple_frame_set_level) };
...
pub unsafe fn set_parent(frame: usize, parent: usize) -> bool {
    ...
    if frame_simple {
        ...
        let f: CSimpleFrameSetParentFn =
            unsafe { core::mem::transmute(crate::addresses::get().c_simple_frame_set_parent) };
    ...
    let f: CLayerSetOwnerFn =
        unsafe { core::mem::transmute(crate::addresses::get().c_layer_set_owner) };
...
pub unsafe fn set_tooltip(frame: usize, tooltip: usize) -> bool {
    ...
    let f: CLayerSetTooltipFn =
        unsafe { core::mem::transmute(crate::addresses::get().c_layer_set_tooltip) };
...
unsafe fn set_simple_font_string_text(frame: usize, text: *const i8) {
    ...
    let f: CSimpleFontStringSetTextFn =
        unsafe { core::mem::transmute(crate::addresses::get().c_simple_font_string_set_text) };
    unsafe { f(frame, text) };
}
...
unsafe fn set_text_frame_text(frame: usize, text: *const i8) {
    ...
    let f: CTextFrameSetTextFn =
        unsafe { core::mem::transmute(crate::addresses::get().c_text_frame_set_text) };
    unsafe { f(frame, text) };
}
    ...
    match ft {
        FrameType::CEditBox | FrameType::CGlueEditBoxWar3 | FrameType::CSlashChatBox => {
            let f: CEditBoxSetTextFn =
                unsafe { core::mem::transmute(crate::addresses::get().c_edit_box_set_text) };
        ...
        FrameType::CTextArea => {
            let f: CTextAreaSetTextFn =
                unsafe { core::mem::transmute(crate::addresses::get().c_text_area_set_text) };
            unsafe { f(frame, text) };
            true
        }
        FrameType::CSimpleButton => {
    ...
    match ft {
        FrameType::CTextArea => {
            let f: CTextAreaAddTextFn =
                unsafe { core::mem::transmute(crate::addresses::get().c_text_area_add_text) };
            unsafe { f(frame, text) };
            true
        }
        _ => false,
...
unsafe fn set_simple_region_color(frame: usize, color: u32) {
    let f: CSimpleRegionSetColorFn =
        unsafe { core::mem::transmute(crate::addresses::get().c_simple_region_set_vertex_color) };
